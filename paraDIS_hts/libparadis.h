/* $Id: libparadis.h,v 1.4 2007/06/29 23:49:54 rcook Exp $ 
 $File$
*/
#ifndef LIBPARADIS_H
#define LIBPARADIS_H

#define LIBPARADIS_HEADER_ID "$Revision: 1.4 $"
//===========================
...
#define BOUNDARY (2)
  ...
  struct node {
    ...
    char terminalNode, filtered, drawn; 
...
#define ARM_NN_100 8
  ...
  struct DataSet {
	...
	void ResetData(void) ; 
    void GetBounds(char *filename, int oldstyle) ;
    void ParseDumpFile(char *filename, int oldstyle) ;
